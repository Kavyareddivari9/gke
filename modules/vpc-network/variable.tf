...
variable "private_subnetwork_secondary_range_name" {
...
variable "private_services_secondary_range_name" {
...
variable "allowed_private_restricted_subnetworks" {
  description = "The private networks that is allowed access to the private_restricted subnetwork of the network"
  default     = []
  type        = list(string)
}
